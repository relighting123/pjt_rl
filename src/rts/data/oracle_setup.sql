...
DROP TABLE RTS_RESULT_INF CASCADE CONSTRAINTS PURGE;
DROP TABLE RTS_INVALIDEQP_INF CASCADE CONSTRAINTS PURGE;
DROP TABLE RTS_WIP_MAS CASCADE CONSTRAINTS PURGE;
DROP TABLE RTS_EQP_MAS CASCADE CONSTRAINTS PURGE;
DROP TABLE RTS_CVRULE_INF CASCADE CONSTRAINTS PURGE;
DROP TABLE RTS_PRODEQPMAP_INF CASCADE CONSTRAINTS PURGE;

-- 1. Equipment Capabilities Table
CREATE TABLE RTS_PRODEQPMAP_INF (
...
CREATE TABLE RTS_INVALIDEQP_INF (
    RULE_TIMEKEY    VARCHAR2(14) NOT NULL,
    MODEL           VARCHAR2(100) NOT NULL,
